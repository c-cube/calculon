...
(* OASIS_START *)
(* DO NOT EDIT (digest: 6a09cce19827fc9b33a1003b1c9425f5) *)
(*
...
let setup_t =
  {
     ...
     package =
       {
          ...
          authors =
            [
               "Simon Cruanes";
               "Arma\195\171l Gu\195\169neau";
               "Joris Giovannangeli"
            ];
          homepage = Some "https://github.com/c-cube/calculon";
          bugreports = None;
            ...
            [
               Flag
                 ({
                   ...
                   {
                      flag_description =
                        Some "Build the web-dependent plugins";
               ...
               Flag
                 ({
                   ...
                   {
                      flag_description = Some "Build the \"extras\" plugins";
                      flag_default = [(OASISExpr.EBool true, true)]
                   });
               Library
                 ({
                  ...
                  },
                   {
                      ...
                      bs_build_depends =
                        [
                           ...
                           FindlibPackage ("re.perl", None);
                           FindlibPackage ("irc-client.lwt", None);
                           FindlibPackage ("irc-client.tls", None);
                           FindlibPackage ("lwt.unix", None);
                           FindlibPackage ("stringext", None);
                           FindlibPackage ("ISO8601", None)
                        ];
               ...
               Library
                 ({
                   ...
                   },
                   {
                      ...
                      lib_pack = true;
                      lib_internal_modules = [];
                      lib_findlib_parent = Some "calculon";
                      lib_findlib_name = Some "web";
                      lib_findlib_directory = None;
                      lib_findlib_containers = []
                   });
               Library
                 ({
                     cs_name = "calculon_extras";
                     cs_data = PropList.Data.create ();
                     cs_plugin_data = []
                  },
                   {
                   ...
                   {
                      lib_modules = ["Plugin_markcough"; "Irclog"];
                      lib_pack = true;
                      lib_internal_modules = [];
                      lib_findlib_parent = Some "calculon";
                      lib_findlib_name = Some "extras";
                      lib_findlib_directory = None;
                      lib_findlib_containers = []
                   });
               Executable
                 ({
                  ...
                  },
                   {
                      ...
                      bs_build_depends =
                        [
                           InternalLibrary "calculon_web";
                           InternalLibrary "calculon_extras"
                        ];
                      bs_build_tools = [ExternalTool "ocamlbuild"];
                      bs_interface_patterns =
                        [
                   ...
                   {exec_custom = false; exec_main_is = "demo_bot.ml"});
               Executable
                 ({
                     cs_name = "markcough_learn";
                     cs_data = PropList.Data.create ();
                     cs_plugin_data = []
                  },
                   {
                   ...
                   {exec_custom = false; exec_main_is = "markcough_learn.ml"});
               Executable
                 ({
                     cs_name = "markcough_show";
                     cs_data = PropList.Data.create ();
                     cs_plugin_data = []
                  },
                   {
                   ...
                   {exec_custom = false; exec_main_is = "markcough_show.ml"});
               Doc
                 ({
                     cs_name = "calculon";
                     cs_data = PropList.Data.create ();
          ...
          build_custom =
            {
               pre_command =
                 [(OASISExpr.EBool true, Some (("make", ["atdgen"])))];
               post_command = [(OASISExpr.EBool true, None)]
            };
     ...
     oasis_version = "0.4.8";
     oasis_digest = Some "\251k\137=\018\165\168\239?\161,\016\020\127U9";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false
  };;
